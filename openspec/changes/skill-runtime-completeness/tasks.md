...
- **P4 治理规范** ✅ 已完成（本 commit）—— `materializeSkill` frontmatter 必填(name+description) + 体积上限(512KB) + `SKILL-AUTHORING-GUIDE.md`（编写规范/Skill vs MCP/权限矩阵复核）。
- **P0–P4 全部完成**，skill-runtime-completeness change 收官。
