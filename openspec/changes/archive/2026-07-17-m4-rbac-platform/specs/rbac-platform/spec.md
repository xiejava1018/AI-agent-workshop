...
(无 —— 现有 specs 无需修改。本 change 全是新增能力。)
...
- 设计文档:`docs/plans/2026-07-17-rbac-platform-design.md`
- 参考实现:`/Users/xiejava/AIproject/TF-TrailVerDev`(commit `ff81ae8`)
- UI 设计:`docs/ui-design/index.html`
- 既有 RBAC:`apps/web/lib/team-auth.ts`、`apps/web/lib/server-user.ts`
- 既有审计:`apps/web/lib/audit-log.ts`